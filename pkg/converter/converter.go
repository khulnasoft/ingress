...
// GlobalMiddleware is called with a default kengine config
// already configured with:
//   - Secret storage store
//   - A TLS App (https://khulnasoft.com/docs/json/apps/tls/)
//   - A HTTP App with an HTTP server listening to 80 443 ports (https://khulnasoft.com/docs/json/apps/http/)
...
// IngressMiddleware is called for each Kengine route that is generated for a specific
// ingress. It allows anyone to manipulate kengine routes before sending it to kengine.
