...
const (
	...
	leasePrefix        = "kengine-lock-"

	keyPrefix = "kengine.ingress--"
)
...
func init() {
	kengine.RegisterModule(SecretStorage{})
}

func (SecretStorage) KengineModule() kengine.ModuleInfo {
	return kengine.ModuleInfo{
		ID:  "kengine.storage.secret_store",
		New: func() kengine.Module { return new(SecretStorage) },
	}
}
