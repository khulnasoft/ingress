...
func TestRedirectConvertToKengineConfig(t *testing.T) {
	rp := RedirectPlugin{}
	...
	tests := []struct {
	...
	}{
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect": "http://example.com",
			},
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect":      "http://example.com",
				"kengine.ingress.kubernetes.io/permanent-redirect-code": "308",
			},
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect":      "http://example.com",
				"kengine.ingress.kubernetes.io/permanent-redirect-code": "401",
			},
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/temporal-redirect": "http://example.com",
			},
		},
	}
...
func TestMisconfiguredRedirectConvertToKengineConfig(t *testing.T) {
	rp := RedirectPlugin{}
	...
	tests := []struct {
	...
	}{
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect":      "http://example.com",
				"kengine.ingress.kubernetes.io/permanent-redirect-code": "502",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect":      "http://example.com",
				"kengine.ingress.kubernetes.io/permanent-redirect-code": "randomstring",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/permanent-redirect": "http://example.com",
				"kengine.ingress.kubernetes.io/temporal-redirect":  "http://example2.com",
			},
