...
func TestTrustedProxesConvertToKengineConfig(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "192.168.1.0, 10.0.0.1",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "192.168.1.0/16,10.0.0.1/8",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "2001:db8::1, 2001:db8::5",
			},
		...
		},
		{
			name: "ipv6 trusted proxies",
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "2001:db8::1/36,2001:db8::5/60",
			},
...
func TestMisconfiguredTrustedProxiesConvertToKengineConfig(t *testing.T) {
	rpp := ReverseProxyPlugin{}
	...
	tests := []struct {
	...
	}{
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "999.999.999.999",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "999.999.999.999/32",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "10.0.0.0/100",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "2001:db8::g",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "2001:db8::g/128",
			},
		...
		},
		{
			...
			annotations: map[string]string{
				"kengine.ingress.kubernetes.io/trusted-proxies": "2001:db8::/200",
			},
