...
func (c *KengineController) onIngressAdded(obj *v1.Ingress) {
...
func (c *KengineController) onIngressUpdated(old *v1.Ingress, new *v1.Ingress) {
...
func (c *KengineController) onIngressDeleted(obj *v1.Ingress) {
	c.syncQueue.Add(IngressDeletedAction{
		resource: obj,
	})
}

func (r IngressAddedAction) handle(c *KengineController) error {
...
func (r IngressUpdatedAction) handle(c *KengineController) error {
...
func (r IngressDeletedAction) handle(c *KengineController) error {
	c.logger.Infof("Ingress deleted (%s/%s)", r.resource.Namespace, r.resource.Name)

	// delete all resources from kengine config that are associated with this resource
