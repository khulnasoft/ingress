...
func (c *KengineController) onConfigMapAdded(obj *v1.ConfigMap) {
...
func (c *KengineController) onConfigMapUpdated(old *v1.ConfigMap, new *v1.ConfigMap) {
...
func (c *KengineController) onConfigMapDeleted(obj *v1.ConfigMap) {
	c.syncQueue.Add(ConfigMapDeletedAction{
		resource: obj,
	})
}

func (r ConfigMapAddedAction) handle(c *KengineController) error {
...
func (r ConfigMapUpdatedAction) handle(c *KengineController) error {
...
func (r ConfigMapDeletedAction) handle(c *KengineController) error {
