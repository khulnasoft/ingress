...
func (c *KengineController) onSecretAdded(obj *apiv1.Secret) {
...
func (c *KengineController) onSecretUpdated(old *apiv1.Secret, new *apiv1.Secret) {
...
func (c *KengineController) onSecretDeleted(obj *apiv1.Secret) {
...
func (r SecretAddedAction) handle(c *KengineController) error {
	c.logger.Infof("TLS secret created (%s/%s)", r.resource.Namespace, r.resource.Name)
	return writeFile(r.resource)
}

func (r SecretUpdatedAction) handle(c *KengineController) error {
	c.logger.Infof("TLS secret updated (%s/%s)", r.resource.Namespace, r.resource.Name)
	return writeFile(r.resource)
}

func (r SecretDeletedAction) handle(c *KengineController) error {
...
func (c *KengineController) watchTLSSecrets() error {
