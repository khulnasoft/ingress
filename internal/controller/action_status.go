...
func (c *KengineController) dispatchSync() {
...
func (r SyncStatusAction) handle(c *KengineController) error {
...
func (c *KengineController) syncStatus(ings []*networkingv1.Ingress) error {
...
func (c *KengineController) updateIngStatuses(controllerAddresses []networkingv1.IngressLoadBalancerIngress, ings []*networkingv1.Ingress) {
